    ...
    <div className="relative min-h-screen w-full flex items-center justify-center p-4 overflow-hidden bg-[#142219]">
      ...
      <div className="relative w-full max-w-md backdrop-blur-2xl bg-[#F8F4E9]/85 border border-white/50 rounded-3xl shadow-2xl shadow-black/30 p-6 sm:p-8 md:p-10">
        ...
        <div className="flex flex-col items-center mb-6 sm:mb-8">
          ...
          <p className="mt-1 text-sm text-[#8A8271]">Sign in to manage your hotel</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <label
              htmlFor="email"
              className="flex items-center gap-1.5 text-sm font-medium text-[#3F3B32] mb-2"
            >
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-xl bg-white/60 border border-[#E2D9C2] text-[#1D1B16] placeholder:text-[#A39C89] outline-none focus:ring-2 focus:ring-[#B4884F]/50 focus:border-[#B4884F] focus:bg-white/80 transition-all"
            />
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                placeholder="••••••••"
                className="w-full px-4 py-3 pr-11 rounded-xl bg-white/60 border border-[#E2D9C2] text-[#1D1B16] placeholder:text-[#A39C89] outline-none focus:ring-2 focus:ring-[#B4884F]/50 focus:border-[#B4884F] focus:bg-white/80 transition-all"
              />
              <button
                type="button"
          ...
          <button
            type="submit"
            disabled={isPending}
            className="w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-[#4F6B52] hover:bg-[#3F5A43] text-white font-semibold tracking-wide shadow-lg shadow-[#4F6B52]/30 active:scale-[0.98] transition-all disabled:opacity-60 disabled:cursor-not-allowed disabled:active:scale-100"
          >
