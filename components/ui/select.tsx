...
import { ArrowDown01Icon, ArrowUp01Icon, CheckListIcon, SeatSelectorIcon } from "hugeicons-react"
  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <SeatSelectorIcon className="pointer-events-none size-4 text-muted-foreground" />
    ...
    >
      <span className="pointer-events-none absolute right-2 flex size-4 items-center justify-center">
        <SelectPrimitive.ItemIndicator>
          <CheckListIcon className="pointer-events-none" />
        </SelectPrimitive.ItemIndicator>
      </span>
